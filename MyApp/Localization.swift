...
enum L10n {
    ...
    האפליקציה עשויה לאפשר העלאת תמונות או קבצים ושמירתם בתשתיות האחסון שלה.

    תמונות וקבצים אינם עוברים בהכרח תהליך אוטומטי להסרת פרטים מזהים.

    לפני העלאת תמונה או קובץ, המשתמש/ת אחראי/ת לבדוק כי קיימת הרשאה להעלותם וכי הם אינם כוללים פרטים מזהים או מידע שאינו נחוץ, לרבות שמות, פנים, כתובות, מספרי זהות, פרטי קשר או מסמכים מזהים.

    אין להעלות תמונה, צילום מסך או מסמך הכוללים מידע שאסור למשתמש/ת להעביר או לשמור בשירות חיצוני.
    ...
    13. פרטיות וספקי שירות חיצוניים

    השימוש במידע כפוף גם למדיניות הפרטיות של CBTipul, המהווה חלק מתנאי שימוש אלה.

    האפליקציה משתמשת בספקי שירות חיצוניים, ובהם Supabase לצורכי אימות, מסד נתונים, אחסון ופונקציות שרת, ו-OpenAI API לצורכי תמלול, הסרת פרטים מזהים ועיבוד מבוסס בינה מלאכותית.
    ...
    מחיקת החשבון מיועדת למחוק את החשבון ואת המידע המשויך אליו, לרבות מידע וקבצים שנשמרו עבורו, בכפוף למידע שקיימת חובה חוקית לשמור ולמשך הזמן הנדרש להשלמת מחיקה ממערכות גיבוי.
